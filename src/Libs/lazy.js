...
(function(context) {
  ...
  Sequence.prototype.skip = Sequence.prototype.tail = Sequence.prototype.drop = function drop(
    count
  ) {
  ...
  SimpleIntersectionSequence.prototype.eachMemoizerCache = function eachMemoizerCache(
    fn
  ) {
  ...
  SplitStreamSequence.prototype.getEachForDelimiter = function getEachForDelimiter(
    delimiter
  ) {
  ...
  Lazy.range = function range() {
    ...
    return this.generate(function(i) {
      return start + step * i;
  ...
  function cloneRegex(pattern) {
    return "" + pattern + (!pattern.global ? "g" : "");
  }
